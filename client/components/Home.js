  ...
  constructor(props) {
    ...
    this.state = {
      ...
      paddle: {
        ...
        paddleWidth: 75,
        paddleX: 0,
        //paddleX is starting point. defining in Comp mount but since
        //canvas dimensions will be consistent, eventually can define starting params
        //in state most likely
      },
      controls: {
        rightPressed: false,
        leftPressed: false,
